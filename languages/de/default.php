 ...
 * Content Elements
 */
$GLOBALS['TL_LANG']['CTE']['foundation']                        = 'Foundation Responsive Elemente';
$GLOBALS['TL_LANG']['CTE']['foundation_sidenav']                = array('Foundation Side Nav', 'Eine Foundation Seiten-Navigation hinzufügen.');
$GLOBALS['TL_LANG']['CTE']['foundation_rowstart']               = array('Foundation Row START', 'Einen Start-Wrapper für eine Foundation Zeile hinzufügen.');
$GLOBALS['TL_LANG']['CTE']['foundation_rowstop']                = array('Foundation Row STOP', 'Einen Stop-Wrapper für eine Foundation Zeile hinzufügen.');
$GLOBALS['TL_LANG']['CTE']['foundation_genericstart']           = array('General Wrapper START', 'Einen Start-Wrapper für ein Foundation Element hinzufügen.');
$GLOBALS['TL_LANG']['CTE']['foundation_genericstop']            = array('General Wrapper STOP', 'Einen Stop-Wrapper für ein Foundation Element hinzufügen.');
 ...
 * Foundation
 */
$GLOBALS['TL_LANG']['MSC']['FOUNDATION']['columns']             = 'Span %s columns';
$GLOBALS['TL_LANG']['MSC']['FOUNDATION']['offset']              = 'Offset %s columns';
$GLOBALS['TL_LANG']['MSC']['FOUNDATION']['push']                = 'Push %s columns';
$GLOBALS['TL_LANG']['MSC']['FOUNDATION']['pull']                = 'Pull %s columns';
