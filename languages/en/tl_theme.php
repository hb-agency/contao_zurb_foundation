...
$GLOBALS['TL_LANG']['tl_theme']['foundation_break_xxlarge'] = array('XX-large breakpoint', 'Enter the xx-large breakpoint. Note that this will be used for the max setting for the x-large breakpoint, and the xx-large breakpoint will be slightly larger (0.063em larger assuming a 16px base).'); 
$GLOBALS['TL_LANG']['tl_theme']['foundation_largegrids']   = array('Include large grids', 'Checking this box will include the Foundation xlarge and xxlarge grid sizes. Leave unchecked to streamline the Foundation CSS if you will not be using these sizes.'); 

/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_theme']['foundation_legend'] = 'Foundation responsive settings';